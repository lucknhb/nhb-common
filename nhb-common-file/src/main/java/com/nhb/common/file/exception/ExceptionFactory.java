...
public class ExceptionFactory {
     ...
     * @param e 源异常
     */
    public static FileStorageException upload(FileInfo fileInfo, String platform, Exception e) {
     ...
     * @param platform 存储平台名称
     */
    public static FileStorageException uploadNotSupportAcl(FileInfo fileInfo, String platform) {
        return new FileStorageException(
     ...
     * @param platform 存储平台名称
     */
    public static FileStorageException uploadNotSupportMetadata(FileInfo fileInfo, String platform) {
        return new FileStorageException(
     ...
     * @param platform 存储平台名称
     */
    public static FileStorageException uploadRequireFileSize(FileInfo fileInfo, String platform) {
        return new FileStorageException(StrUtil.format(UPLOAD_REQUIRE_SIZE_MESSAGE_FORMAT, platform, fileInfo));
    }
     ...
     * @param platform 存储平台名称
     * @param e 源异常
     * @return {@link FileStorageException}
     */
    public static FileStorageException initiateMultipartUpload(FileInfo fileInfo, String platform, Exception e) {
        return new FileStorageException(
     ...
     * @param platform 存储平台名称
     */
    public static FileStorageException initiateMultipartUploadRequireFileSize(
     ...
     * @return {@link FileStorageException}
     */
    public static FileStorageException initiateMultipartUploadRecorderSave(
     ...
     * @return {@link FileStorageException}
     */
    public static FileStorageException uploadPart(FileInfo fileInfo, String platform, Exception e) {
        return new FileStorageException(StrUtil.format(UPLOAD_PART_MESSAGE_FORMAT, platform, fileInfo), e);
    }
     ...
     * @return {@link FileStorageException}
     */
    public static FileStorageException completeMultipartUpload(FileInfo fileInfo, String platform, Exception e) {
        return new FileStorageException(
     ...
     * @return {@link FileStorageException}
     */
    public static FileStorageException abortMultipartUpload(FileInfo fileInfo, String platform, Exception e) {
        return new FileStorageException(
     ...
     * @return {@link FileStorageException}
     */
    public static FileStorageException listParts(FileInfo fileInfo, String platform, Exception e) {
        return new FileStorageException(StrUtil.format(LIST_PARTS_MESSAGE_FORMAT, platform, fileInfo), e);
    }
     ...
     * @return {@link FileStorageException}
     */
    public static FileStorageException listFiles(ListFilesPretreatment pre, String basePath, Exception e) {
        return new FileStorageException(
                StrUtil.format(
     ...
     * @return {@link FileStorageException}
     */
    public static FileStorageException getFile(GetFilePretreatment pre, String basePath, Exception e) {
        return new FileStorageException(
                StrUtil.format(
     ...
     * @return {@link FileStorageException}
     */
    public static FileStorageException unrecognizedAcl(Object acl, String platform) {
        return new FileStorageException(StrUtil.format(UNRECOGNIZED_ACL_MESSAGE_FORMAT, platform, acl));
    }
     ...
     * @return {@link FileStorageException}
     */
    public static FileStorageException generatePresignedUrl(GeneratePresignedUrlPretreatment pre, Exception e) {
        return new FileStorageException(
     ...
     * @return {@link FileStorageException}
     */
    public static FileStorageException generatePresignedUrl(FileInfo fileInfo, String platform, Exception e) {
        return new FileStorageException(
     ...
     * @return {@link FileStorageException}
     */
    public static FileStorageException generateThPresignedUrl(FileInfo fileInfo, String platform, Exception e) {
        return new FileStorageException(
     ...
     * @return {@link FileStorageException}
     */
    public static FileStorageException setFileAcl(FileInfo fileInfo, Object acl, String platform, Exception e) {
        return new FileStorageException(StrUtil.format(SET_FILE_ACL_MESSAGE_FORMAT, platform, fileInfo, acl), e);
    }
     ...
     * @return {@link FileStorageException}
     */
    public static FileStorageException setThFileAcl(
     ...
     * @param e 源异常
     */
    public static FileStorageException delete(FileInfo fileInfo, String platform, Exception e) {
        return new FileStorageException(
     ...
     * @param e 源异常
     */
    public static FileStorageException exists(FileInfo fileInfo, String platform, Exception e) {
        return new FileStorageException(
     ...
     * @return {@link FileStorageException}
     */
    public static FileStorageException download(FileInfo fileInfo, String platform, Exception e) {
        return new FileStorageException(StrUtil.format(DOWNLOAD_MESSAGE_FORMAT, platform, fileInfo), e);
    }
     ...
     * @return {@link FileStorageException}
     */
    public static FileStorageException downloadTh(FileInfo fileInfo, String platform, Exception e) {
        return new FileStorageException(StrUtil.format(DOWNLOAD_TH_MESSAGE_FORMAT, platform, fileInfo), e);
    }
     ...
     * @return {@link FileStorageException}
     */
    public static FileStorageException downloadThNotFound(FileInfo fileInfo, String platform) {
        return new FileStorageException(
     ...
     * @param platform 存储平台名称
     */
    public static FileStorageException sameCopyNotSupportAcl(
     ...
     * @param platform 存储平台名称
     */
    public static FileStorageException sameCopyNotSupportMetadata(
            FileInfo srcFileInfo, FileInfo destFileInfo, String platform) {
        return new FileStorageException(
     ...
     * @param platform     存储平台名称
     */
    public static FileStorageException sameCopyBasePath(
            String basePath, FileInfo srcFileInfo, FileInfo destFileInfo, String platform) {
        return new FileStorageException(StrUtil.format(
     ...
     * @return {@link FileStorageException}
     */
    public static FileStorageException sameCopyNotFound(
     ...
     * @return {@link FileStorageException}
     */
    public static FileStorageException sameCopyCreatePath(
            FileInfo srcFileInfo, FileInfo destFileInfo, String platform, Exception e) {
        return new FileStorageException(
     ...
     * @return {@link FileStorageException}
     */
    public static FileStorageException sameCopyTh(
            FileInfo srcFileInfo, FileInfo destFileInfo, String platform, Exception e) {
        return new FileStorageException(
     ...
     * @return {@link FileStorageException}
     */
    public static FileStorageException sameCopy(
            FileInfo srcFileInfo, FileInfo destFileInfo, String platform, Exception e) {
        return new FileStorageException(
     ...
     * @param platform 存储平台名称
     */
    public static FileStorageException sameMoveNotSupportAcl(
            FileInfo srcFileInfo, FileInfo destFileInfo, String platform) {
        return new FileStorageException(
     ...
     * @param platform 存储平台名称
     */
    public static FileStorageException sameMoveNotSupportMetadata(
            FileInfo srcFileInfo, FileInfo destFileInfo, String platform) {
        return new FileStorageException(
     ...
     * @param platform     存储平台名称
     */
    public static FileStorageException sameMoveBasePath(
            String basePath, FileInfo srcFileInfo, FileInfo destFileInfo, String platform) {
        return new FileStorageException(StrUtil.format(
     ...
     * @return {@link FileStorageException}
     */
    public static FileStorageException sameMoveNotFound(
            FileInfo srcFileInfo, FileInfo destFileInfo, String platform, Exception e) {
        return new FileStorageException(
     ...
     * @return {@link FileStorageException}
     */
    public static FileStorageException sameMoveCreatePath(
            FileInfo srcFileInfo, FileInfo destFileInfo, String platform, Exception e) {
        return new FileStorageException(
     ...
     * @return {@link FileStorageException}
     */
    public static FileStorageException sameMoveTh(
            FileInfo srcFileInfo, FileInfo destFileInfo, String platform, Exception e) {
        return new FileStorageException(
     ...
     * @return {@link FileStorageException}
     */
    public static FileStorageException sameMove(
            FileInfo srcFileInfo, FileInfo destFileInfo, String platform, Exception e) {
        return new FileStorageException(
