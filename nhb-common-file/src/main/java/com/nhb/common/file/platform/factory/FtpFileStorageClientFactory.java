...
public class FtpFileStorageClientFactory implements FileStorageClientFactory<Ftp> {
    ...
    public Ftp getClient() {
        try {
            ...
            throw new FileStorageException("获取 FTP Client 失败！", e);
        }
    }
    ...
    public void returnClient(Ftp sftp) {
        try {
            ...
            throw new FileStorageException("归还 FTP Client 失败！", e);
        }
    }
    ...
    public static class FtpPooledObjectFactory extends BasePooledObjectFactory<Ftp> {
        ...
        @Override
        public Ftp create() {
            if (factory == null) throw new FileStorageException("FTP 连接失败！config 不能为空");
            try {
                return new Ftp(
                ...
                throw new FileStorageException("FTP 连接失败！platform：" + factory.getPlatform(), e);
            }
        }
        ...
        public void destroyObject(PooledObject<Ftp> p) {
            try {
                ...
                throw new FileStorageException("销毁 Ftp 对象失败！", e);
            }
        }
    }
}
