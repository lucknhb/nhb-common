 ...
 * @version 1.0
 * @date 2026/3/9 15:01
 * @description: Mongo GridFS 存储平台的 Client 工厂
 */
@Getter
@Setter
@NoArgsConstructor
public class MongoGridFsFileStorageClientFactory implements FileStorageClientFactory<MongoGridFsFileStorageClientFactory.MongoGridFsClient> {
    ...
    public MongoGridFsFileStorageClientFactory(FileStorageProperties.MongoGridFsConfig config) {
