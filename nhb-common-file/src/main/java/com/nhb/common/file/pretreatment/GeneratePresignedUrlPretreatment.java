...
import com.nhb.common.file.actuator.GeneratePresignedUrlActuator;
...
public class GeneratePresignedUrlPretreatment {
     ...
     * {@link FileStorageConstants.GeneratePresignedUrl.Method}
     */
     ...
     * @return 获取文件预处理器
     */
    public GeneratePresignedUrlPretreatment setFileStorageService(boolean flag,
    ...
    public GeneratePresignedUrlPretreatment putUserMetadataAll(boolean flag, Map<String, String> userMetadata) {
        if (flag) {
            putUserMetadataAll(userMetadata);
        }
        return this;
    }
    ...
    public GeneratePresignedUrlPretreatment putResponseHeadersAll(boolean flag, Map<String, String> responseHeader) {
        if (flag) {
            putResponseHeadersAll(responseHeader);
        }
        return this;
    }
    ...
    public GeneratePresignedUrlPretreatment setVersionId(boolean flag, String versionId) {
        if (flag) {
            putQueryParams("versionId", versionId);
        }
        return this;
    }
