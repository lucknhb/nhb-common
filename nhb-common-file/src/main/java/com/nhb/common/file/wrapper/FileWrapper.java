...
import com.nhb.common.file.exception.IOExceptionConsumer;
import com.nhb.common.file.exception.IOExceptionFunction;
...
public interface FileWrapper {
     ...
     * 移动文件
     */
    default void transferTo(File target) {
        throw new FileStorageException("Current FileWrapper Not Support TransferTo Method");
    }
