...
import com.nhb.common.mybatis.enums.DataType;
...
public class DataBaseHelper {
    private static final DynamicRoutingDataSource DS = SpringContextUtil.getBean(DynamicRoutingDataSource.class);
    ...
    public static DataType getDataType() {
        ...
        try (Connection conn = dataSource.getConnection()) {
            ...
            return DataType.find(databaseProductName);
        } catch (SQLException e) {
            throw new RuntimeException("Failed To Get The Database Type", e);
        }
    }
