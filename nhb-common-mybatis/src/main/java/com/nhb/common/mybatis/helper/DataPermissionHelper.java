...
public class DataPermissionHelper {
    ...
    private static final FastThreadLocal<DataPermission> PERMISSION_CACHE = new FastThreadLocal<>();
    ...
    private static void enableIgnore() {
        ...
        ConcurrentLinkedDeque<Integer> reentrantDeque = REENTRANT_IGNORE.get();
        reentrantDeque.push(reentrantDeque.size() + 1);
    }
    ...
    private static void disableIgnore() {
        ...
        if (ObjectUtil.isNotNull(ignoreStrategy)) {
            ...
            ConcurrentLinkedDeque<Integer> reentrantDeque = REENTRANT_IGNORE.get();
            boolean empty = reentrantDeque.isEmpty() || reentrantDeque.pop() == 1;
