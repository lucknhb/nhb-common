package com.nhb.common.mybatis.helper;
...
public class TenantHelper {
    ...
    private static final FastThreadLocal<String> TEMP_DYNAMIC_TENANT = new FastThreadLocal<>();

    private static final FastThreadLocal<ConcurrentLinkedDeque<Integer>> REENTRANT_IGNORE = new FastThreadLocal<>();

    /**
     * 租户功能是否启用
     */
    public static boolean isEnabled() {
        return Convert.toBool(SpringContextUtil.getProperty("mybatis-plus.tenant.enable"), false);
    }
    ...
    private static void enableIgnore() {
        ...
        ConcurrentLinkedDeque<Integer> reentrantStack = REENTRANT_IGNORE.get();
    ...
    public static void setDynamic(String tenantId, boolean global) {
        ...
        if (!UserContextUtil.isLogin() || !global) {
            TEMP_DYNAMIC_TENANT.set(tenantId);
            return;
        }
        String cacheKey = DYNAMIC_TENANT_KEY + ":" + UserContextUtil.getUserId();
    ...
    public static String getDynamic() {
        ...
        storage.set(cacheKey, StringUtil.isBlank(tenantId) ? "-1" : tenantId);
        return tenantId;
    }
    ...
    public static String getTenantId() {
        ...
        if (StringUtil.isBlank(tenantId)) {
            tenantId = String.valueOf(UserContextUtil.getTenantId());
        }
        return tenantId;
    }
}
