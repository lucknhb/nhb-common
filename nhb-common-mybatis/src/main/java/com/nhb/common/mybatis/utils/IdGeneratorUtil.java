package com.nhb.common.mybatis.utils;
 ...
 * @author luck_nhb
 * @version 1.0
 * @date 2026/3/19 14:11
 * @description:
 */
@Slf4j
@NoArgsConstructor(access = AccessLevel.PRIVATE)
public class IdGeneratorUtil {
    private static final IdentifierGenerator GENERATOR = SpringContextUtil.getBean(IdentifierGenerator.class);
