package com.nhb.common.office.handler;
...
import com.nhb.common.office.annotation.ExcelDynamicOptions;
import com.nhb.common.office.annotation.ExcelEnumFormat;
    ...
    public void afterSheetCreate(WriteWorkbookHolder writeWorkbookHolder, WriteSheetHolder writeSheetHolder) {
        ...
        for (Map.Entry<Integer, FieldWrapper> entry : fieldCache.getSortedFieldMap().entrySet()) {
            ...
            if (field.isAnnotationPresent(ExcelEnumFormat.class)) {
                ...
                List<Object> values = EnumUtil.getFieldValues(format.enumClass(), format.valueField());
                options = StreamUtil.toList(values, Convert::toStr);
                ...
                // 获取提供者实例
                ExcelOptionsProvider provider = SpringContextUtil.getBean(dynamicOptions.providerClass());
